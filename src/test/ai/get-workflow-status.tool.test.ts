...
describe('GetWorkflowStatusTool', () => {
  ...
  const sampleWorkflow: WorkflowDefinition = {
    ...
    detectedRisks: [],
    stages: [
      { id: 'onboard', name: 'Onboard', status: 'completed', skippable: true, entryConditions: [], exitConditions: [], artifacts: [] },
    ...
    qualityGates: [
      { id: 'tests-pass', name: 'Tests Pass', type: 'automated', status: 'pending', stage: 'verify', blocking: true, conditional: false },
    ],
    approvals: [
      { id: 'approval-spec', level: 'explicit', artifact: 'spec', status: 'pending' },
    ],
    activeSkills: [],
